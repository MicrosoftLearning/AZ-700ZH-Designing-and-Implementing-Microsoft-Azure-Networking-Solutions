...
2. 在“热门产品/服务”列表中，选择“**Windows Server Datacenter 2019**”。
...
16. 在 **Srv-workload-02** 的“**概览**”页面的右侧窗格中，记下“**网络**”部分下的专用 IP 地址（例如，**10.1.1.4**）。
...
2. 从“**防火墙管理器**”中，单击“**查看 Azure 防火墙策略**”。

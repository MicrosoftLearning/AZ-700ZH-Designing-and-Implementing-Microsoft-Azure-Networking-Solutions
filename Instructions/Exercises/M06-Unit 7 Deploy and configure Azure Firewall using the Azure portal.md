...
1. 在 Azure 门户主页上，选择“**创建资源**”，然后在搜索框中键入“**虚拟网络**”，然后单击出现的“**虚拟网络**”。
...
9. 单击“**保存**”。
   ...
   ![创建虚拟网络 - 编辑子网](../media/edit-default-subnet-for-firewall.png)
...
1. 在 Azure 门户主页上，选择“**创建资源**”，然后在搜索框中键入“**虚拟机**”，然后选择出现的“**虚拟机**”。
...
3. 在“**基本**”信息选项卡上，使用下表中的信息创建新 VM。
   ...
   | 区域               | 你所在的区域                                                  |
   | 可用性选项 | **无需基础结构冗余**                    |
   | 映像                | **Windows Server 2016 Datacenter - Gen 1**                   |
   | 大小                 | 选择“**查看所有大小**”，然后在列表中选择“**B1s**”，并选择“**选择**”<br /><br />**（标准_B1s - 1 个 vcpu，1 GiB 内存（8.60 英镑/月））** |
   | 用户名             | **MyAdmin**                                                  |
   | 密码             | **TestPa$$w0rd!**                                            |
   | 确认密码     | **TestPa$$w0rd!**                                            |
   | 公共入站端口 | 选择“**无**”                                             |
